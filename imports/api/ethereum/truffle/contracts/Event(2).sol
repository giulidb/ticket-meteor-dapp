...
contract Event{ 
    ...
    modifier onlyRight(bool right) { if( right == true ) _; else throw; }
    ...
    () {
		owner = msg.sender;	
 		ticketPrice = 5;
 		ticketSold = 0;
 		u = userRegistry(0x1da4da76af66399acc1872764ac797f4627e474b);
	}
	


	function buyTicket() costs(ticketPrice,msg.sender) 
    onlyRight(u.getRight(msg.sender)) public payable{
